export const basePrompt = `<DevfolioArtifact id="project-import" title="Project Files"><DevfolioAction type="file" filePath="next.config.mjs">/** @type {import('next').NextConfig} */
const nextConfig = {
